...
import { ArrowDownward, ArrowUpward, ArtTrackSharp } from '@mui/icons-material'
...
function EnhancedTableToolbar(props: EnhancedTableToolbarProps) {
  const { numSelected, handleDownTrackOrder, handleUpTrackOrder, handleSaveChanges } = props
                      ...
                      <TableCell align='left'>
                        <Stack>
                          <TrackTitle
                            ...
                            artists={`${album.artist.profile.firstname} ${album.artist.profile.lastname}`}
                          />
                        </Stack>
                      </TableCell>
