...
export default function LoginPage() {
  ...
  const handleResetPw = async () => {
    ...
    if (result) {
      ...
      setSnack({
        open: true,
        type: 'error',
        message: 'Reset password successfully! Check your email to retrieve your new password.'
      })
    }
  }
  ...
  return (
    <>
      <Snackbar />
      <title> Forgot Password | Soundee </title>
      <StyledRoot>
        {mdUp && (
          <StyledBanner>
            <Box
            ...
            >
              <Image style={{ objectFit: 'cover', borderRadius: 12 }} fill src={Banner} alt='login' />
            </Box>
          </StyledBanner>
        )}
